...
class TestSidebarRWD:
    ...
    def test_base_sidebar_has_mobile_menu_toggle(self):
        ...
        template_path = (
            Path(__file__).parent.parent / "app/templates/rag/base_sidebar.html"
        )
        content = template_path.read_text()

        # Should have toggle button
        assert (
            "toggleSidebar" in content or "toggle-sidebar" in content
    ...
    def test_sidebar_has_collapse_state(self):
        ...
        assert (
            "hidden" in content or "collapsed" in content or "-translate-x" in content
    ...
    def test_sidebar_has_responsive_breakpoints(self):
        ...
        assert (
            "md:" in content or "lg:" in content
    ...
    def test_sidebar_has_mobile_overlay(self):
        ...
        assert (
            "overlay" in content.lower() or "backdrop" in content.lower()
    ...
    def test_sidebar_javascript_included(self):
        ...
        assert (
            "classList" in content or "toggle" in content.lower()
    ...
    def test_sidebar_width_responsive(self):
        ...
        assert (
            "w-64" in content or "w-80" in content or "w-full" in content
