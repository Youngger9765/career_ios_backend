...
**解決方案**:
整合 Eleven Labs Scribe v2 實時轉錄 API 與 RAG 知識庫，打造**即時 AI 輔助諮詢系統**
...
| 目標 | 指標 | 基準 | 目標值 |
|------|------|------|--------|
| **提升諮詢效率** | 報告生成時間 | 人工 30 分鐘 | AI 輔助 < 5 分鐘 |
| **改善諮詢品質** | 知識引用準確率 | - | > 85% |
| **增加諮詢頻次** | 每日可接案量 | 4 案/天 | 6 案/天 (+50%) |
| **降低諮詢師負擔** | 手動記錄時間 | 15 分鐘/會談 | < 2 分鐘/會談 |
...
**使用者故事**:
> 作為諮詢師，我希望在會談進行時即時看到逐字稿，以便專注傾聽而非記錄
...
**使用者故事**:
> 作為諮詢師，當案主提到「轉職」或「職涯規劃」時，我希望 AI 自動提供相關職涯文章建議
...
**使用者故事**:
> 作為諮詢師，我希望 AI 根據會談內容自動生成建議，讓我可以參考或修改
...
**使用者故事**:
> 作為諮詢師，會談結束後我希望 AI 自動生成摘要報告，節省我的整理時間
...
| 風險 | 影響 | 機率 | 緩解策略 |
|------|------|------|----------|
| **諮詢師不信任 AI 建議** | 高 | 中 | 1. 強調「輔助」非「取代」<br>2. 提供建議來源追溯<br>3. 使用者培訓 |
