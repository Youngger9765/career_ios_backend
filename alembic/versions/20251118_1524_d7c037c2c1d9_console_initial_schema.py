...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("COUNSELOR", "SUPERVISOR", "ADMIN", name="counselorrole"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_counselors_tenant_id"), "counselors", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_counselors_username"), "counselors", ["username"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "COMPLETED", "SUSPENDED", "REFERRED", name="casestatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_cases_case_number"), "cases", ["case_number"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "content_json", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("content_markdown", sa.Text(), nullable=True),
        sa.Column(
            "edited_content_json", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.Column(
            "action_items", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.Column(
            "quality_strengths", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "quality_weaknesses", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_reports_tenant_id"), "reports", ["tenant_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "job_metadata", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["session_id"],
            ["sessions.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "reminder_type",
            sa.Enum("FOLLOW_UP", "APPOINTMENT", "TASK", "REVIEW", name="remindertype"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum(
                "ACTIVE", "COMPLETED", "CANCELLED", "SNOOZED", name="reminderstatus"
            ),
            nullable=False,
        ),
